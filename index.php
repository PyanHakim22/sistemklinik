...
<?php
        ...
        header("Location: halaman.php"); // bawa pengguna ke index.php
        }else{
            echo "<div class='form'><h3>Nama Pengguna/NDP salah.</h3><br/>Klik disini untuk <a href='index.php'>Log  Masuk</a></div>";  // echo : nota atau message yang akan memaparkan "Nama Pengguna/NDP salah"
        }
        }else{
    ?>
