...
<?php
    ...
    echo "<script>window.location.href = 'datapelajar.php'</script>";     
    } 
?>
<!DOCTYPE html>
<html lang="en">
...
<body id="page-top">  
    ...
    <div id="wrapper">  
      ...
      <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">  
          ...
          <!-- Nav Item - Tables -->
            <li class="nav-item active"> 
                <a class="nav-link" href="datapelajar.php"> 
                    <i class="fas fa-fw fa-table"></i> 
                    <span>Data Pelajar</span></a> 
            </li>
                    ...
                    <table class="table table-bordered table-hover w-60" id="example">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td style="height:60px; vertical-align: middle;" class="text-center"><img onclick="FullView(this.src)" src="profilepics/<?php  echo $row['ProfilePic'];?>" width="80" height="80"></td>
                                <td>
                                    <!-- <a href="view.php?viewid=<?php echo htmlentities ($row['ID']);?>" class="view" title="View" data-toggle="tooltip"><i class="material-icons">&#xE417;</i></a> -->
                                    <a href="edit.php?editid=<?php echo htmlentities ($row['ID']);?>" class="btn btn-warning" class="edit" title="Edit" data-toggle="tooltip"><i class="material-icons">&#xE254;</i></a>
                                    <!-- <a href="datapelajar.php?delid=<?php echo ($row['ID']);?>&&ppic=<?php echo $row['ProfilePic'];?>" class="delete" title="Delete" data-toggle="tooltip" onclick="return confirm('Do you really want to Delete ?');"><i class="material-icons">&#xE872;</i></a> -->
                                </td>
                            </tr>
                            <?php 
                                $cnt=$cnt+1;
